...
# - how to perform ISFC (also see the [Dynamic Connectivity](../content/timecorr) tutorial)
...
# ```
# 
# You will want to change `data_dir` to wherever you have installed the Sherlock datalad repository. We will initialize a datalad dataset instance and get the files we need for this tutorial. If you've already downloaded everything, you can skip this cell. See the [Download Data Tutorial](../content/Download_Data) for more information about how to install and use datalad.
